...
var solution = File("./NBomber.Sinks.InfluxDB.sln");
var project = File("./src/NBomber.Sinks.InfluxDB/NBomber.Sinks.InfluxDB.fsproj");
...
Task("Build")
    ...
    .Does(() =>
{
    Information("NBomber.Sinks.InfluxDB Version: {0}", version);
...
Task("Pack")   
    ...
    .Does(() =>
{
	NuGetPack("./NBomber.Sinks.InfluxDB.nuspec", new NuGetPackSettings
	{
        Version = version,
