...
namespace NBomber.Sinks.ParimatchTech.InfluxDB
{
    [Serializable]
    public class ParimatchTechInfluxDBSink : IReportingSink
    {
        ...
        public ParimatchTechInfluxDBSink(string url, string userName, string password, string databaseName)
        {
            _logger = null;
            _context = null;
            _influxdbClient =
        ...
        [SpecialName] public string SinkName => "NBomber.Sinks.ParimatchTech.InfluxDB";

        public Task Init(IBaseContext context, IConfiguration infraConfig)
        {
            _logger = context.Logger.ForContext<ParimatchTechInfluxDBSink>();
            _context = context;
